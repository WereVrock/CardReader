...
// Replace plain JTextArea with styled pane
...
String residual = extract(raw, "Residual quantity of electricity");
String lastAmount = extract(raw, "Amount of power purchase");
String lastDate = extract(raw, "Date of power purchase");
String lastQty = extract(raw, "Quantity of power purchase");

// Look up name from DB - try user code first, then meter number
...
try {
if (!NanometController.isPopupOpen()) {
// DB debug mode - show customer lookup
